...
documentation_input_path = r'{}\documentation.xlsx'.format(software_data_folder_location)

# העברת קובץ התיעוד ללקוח
shutil.copy(documentation_input_path, client_data_folder_location)
