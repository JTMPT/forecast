...
df2 = pd.read_excel(r"C:\Users\dpere\Documents\JTMT\forecast\create_forecast_basic\current\Intermediates\taz_with_pop_info_240225.xlsx")
...
compare = df1.sort_values('Taz_num').compare(df2.sort_values('Taz_num'))
